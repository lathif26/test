...
function TodoTable({ todos, addTodo, updateTodo, deleteTodo }) {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text) => (text ? text.format("MMM DD, YYYY") : "-"),
    },
    {
      title: "Tags",
      dataIndex: "tags",
    ...
    <>
      ...
      >
        <Form
          layout="vertical"
          form={form}
          onFinish={editingTodoId ? handleEditTodoSubmit : handleAddTodoSubmit}
        >
          <Form.Item
            name="title"
            rules={[
            ...
            rules={[
              {
                ...
                max: 1000,
                message:
                  "Description is required and should be less than 1000 characters.",
              },
            ]}
          >
            <Input.TextArea
